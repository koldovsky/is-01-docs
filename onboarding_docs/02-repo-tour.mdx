...
## Diagram (Excalidraw source + SVG)

The same mental model as an Excalidraw diagram:

- Source: [`./diagrams/monorepo-map.excalidraw`](./diagrams/monorepo-map.excalidraw)
- Rendered (GitHub-friendly): `./diagrams/monorepo-map.svg`

<img
  src="./diagrams/monorepo-map.svg"
  alt="Excalidraw monorepo map diagram"
  width="900"
/>
